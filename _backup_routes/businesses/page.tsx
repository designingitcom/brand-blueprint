...
export default function BusinessesPage() {
  ...
  const businessStats = [
    { label: 'Total Businesses', value: businesses.length.toString(), change: 0, icon: Briefcase },
    { label: 'Active Projects', value: '0', change: 0, icon: Building2 },
  ...
  return (
    <DashboardLayout
      title="Businesses"
      subtitle="Manage all businesses across organizations"
      actions={
        <BusinessForm
                ...
                <div className="p-6 pb-4">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-primary mb-1">{business.type || 'No type'}</p>
                      <Link

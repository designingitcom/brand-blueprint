...
export default async function BusinessDetailPage({
  ...
  const businessStats = [
    { label: 'Active Projects', value: activeProjects.toString(), change: 0, icon: Clock },
    { label: 'Completed Projects', value: completedProjects.toString(), change: 0, icon: CheckCircle },
    { label: 'Total Projects', value: projects.length.toString(), change: 0, icon: Building2 },

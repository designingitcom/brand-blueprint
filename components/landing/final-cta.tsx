      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center relative z-10">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="text-xl lg:text-2xl mb-16 text-neutral-400 leading-relaxed">
            Join hundreds of businesses that have revolutionized their marketing
            with a strategy-first Growth OS that actually delivers results.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <button className="px-12 py-6 text-lg bg-white text-neutral-900 hover:bg-neutral-100 rounded-lg transition-all duration-300">
              Start Your Growth OS
            </button>

            <button className="px-12 py-6 text-lg border border-neutral-700 text-white hover:bg-neutral-800 rounded-lg transition-all duration-300">

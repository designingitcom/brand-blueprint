    ...
    (fieldValue: string) => {
      ...
      debounceTimer.current = setTimeout(() => {
        ...
        if (onValidationChange) {
          onValidationChange(id, result.success, result.errors?.[0]);
        }
      }, debounceMs);
    },
      ...
      <div className="relative">
        <Input
          ...
          className={cn(
            ...
            hasWarning &&
              !hasError &&
              'border-neutral-400 focus:border-neutral-500',
      ...
      <div className="relative">
        <textarea
          ...
          className={cn(
            ...
            hasWarning &&
              !hasError &&
              'border-neutral-400 focus:border-neutral-500 focus:ring-neutral-500',
            isFocused && !hasError && !hasWarning && 'border-primary'
          )}
          aria-invalid={hasError}
          aria-describedby={

...
export function BusinessSetupWizardV2({
  userId,
  onComplete,
  existingBusiness,
}: BusinessSetupWizardV2Props) {
  const router = useRouter();
  const [currentStep, setCurrentStep] = useState(1);
  const [isLoading, setIsLoading] = useState(false);
  const [savedBusinessId, setSavedBusinessId] = useState(
    existingBusiness?.id || null
  );
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <RadioGroup
            ...
            onValueChange={value =>
              updateFormData({
                business_type: value as FormData['business_type'],
              })
            }
            className="mt-2"
          >
        ...
        <div>
          ...
          <RadioGroup
            ...
            onValueChange={value =>
              updateFormData({
                years_in_business: value as FormData['years_in_business'],
              })
            }
            className="mt-2"
          >
        ...
        <div>
          ...
          <RadioGroup
            ...
            onValueChange={value =>
              updateFormData({
                employee_count: value as FormData['employee_count'],
              })
            }
            className="mt-2"
          >
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <RadioGroup
            ...
            onValueChange={value =>
              updateFormData({
                business_model: value as FormData['business_model'],
              })
            }
            className="mt-2"
          >
        ...
        <div>
          ...
          <RadioGroup
            ...
            onValueChange={value =>
              updateFormData({
                avg_customer_ltv: value as FormData['avg_customer_ltv'],
              })
            }
            className="mt-2"
          >
            <div className="flex flex-wrap gap-4">
              {['<$1K', '$1-10K', '$10-100K', '$100K+', 'Not sure'].map(ltv => (
                <div key={ltv} className="flex items-center space-x-2">
                  ...
                  <Label htmlFor={ltv} className="text-sm">
                    {ltv}
                  </Label>
                </div>
              ))}
        ...
        <div>
          ...
          <RadioGroup
            ...
            onValueChange={value =>
              updateFormData({
                primary_goal: value as FormData['primary_goal'],
              })
            }
            className="mt-2"
          >

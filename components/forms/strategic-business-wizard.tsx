...
const strategicQuestions = [
  ...
  // Step 6: Obstacles & Transformation (Q3-Q4)
  {
    ...
    description:
      'What barriers prevent them from finding a solution on their own?',
...
export function StrategicBusinessWizard({
  userId,
  onComplete,
  existingBusiness,
}: any) {
  ...
  const generatePositioning = () => {
    ...
    return {
      ...
      problem: formData.strategicResponses.find(r => r.questionId === 'Q1')
        ?.response,
      uniqueValue: formData.strategicResponses.find(r => r.questionId === 'Q14')
        ?.response,
    };
  };
        ...
        {currentStep === 5 && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Who is your primary buyer within the selected segment?
              </p>
            </div>
            ...
            <div className="space-y-4">
              {samplePersonas.map(persona => (
                <Card
                  ...
                  className={cn(
                    'cursor-pointer transition-all',
                    formData.selectedPersona?.id === persona.id &&
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                {currentStep === 9 &&
                  'Position yourself uniquely in the market'}
              </p>
            </div>
            ...
            <div className="space-y-6">
              {strategicQuestions
                .filter(q => {
                  ...
                  if (currentStep === 8)
                    return ['Q5', 'Q6', 'Q7', 'Q8'].includes(q.id);
                  if (currentStep === 9)
                    return [
                      'Q9',
                      'Q10',
                ...
                .map(question => {
                  const response = formData.strategicResponses.find(
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <Textarea
                          ...
                          onChange={e => {
                            ...
                            updateFormData({
                              strategicResponses: newResponses,
                            });
                          }}
        ...
        {currentStep === 10 && (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Here's your complete positioning based on your responses
              </p>
            </div>
            ...
            <Card className="border-primary">
              ...
              <CardContent>
                <p className="text-lg">
                  For {formData.selectedPersona?.name || 'your ideal customers'}{' '}
                  struggling with{' '}
                  {formData.strategicResponses.find(r => r.questionId === 'Q1')
                    ?.response || 'their key problem'}
                  , we're the only{' '}
                  {formData.strategicResponses.find(r => r.questionId === 'Q12')
                    ?.response || 'solution'}{' '}
                  that{' '}
                  {formData.strategicResponses.find(r => r.questionId === 'Q14')
                    ?.response || 'creates unique value'}
                  .
                </p>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm">
                    {formData.selectedSegments.find(s => s.isPrimary)?.title ||
                      'Not selected'}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm">
                    {formData.strategicResponses.find(
                      r => r.questionId === 'Q1'
            ...
            <div className="bg-muted p-4 rounded-lg">
              <p className="text-sm text-center text-muted-foreground">
                🎯 Your positioning is {Math.floor(Math.random() * 20) + 80}%
                ready. You can now proceed to create projects with this
                strategic foundation.
              </p>
            </div>
          </div>
        ...
        {currentStep === 2 && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Tell us more about your business structure and goals
              </p>
            </div>
        ...
        {currentStep === 3 && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                What do you offer and who are your competitors?
              </p>
            </div>

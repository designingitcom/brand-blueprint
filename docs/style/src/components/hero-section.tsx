        ...
        <div className="mx-auto max-w-7xl px-6 pt-32 pb-24 lg:px-8 lg:pt-40 lg:pb-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="px-10 py-4 text-lg bg-neutral-900 hover:bg-neutral-800 text-white rounded-lg"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="px-10 py-4 text-lg border border-neutral-300 text-neutral-900 rounded-lg hover:bg-neutral-50"
              >

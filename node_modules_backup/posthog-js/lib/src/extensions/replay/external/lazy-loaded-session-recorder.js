...
var LazyLoadedSessionRecording = /** @class */ (function () {
    ...
    LazyLoadedSessionRecording.prototype.stop = function () {
        ...
        (_e = this._stopRrweb) === null || _e === void 0 ? void 0 : _e.call(this);
        this._stopRrweb = undefined;
        logger.info('stopped');
    };
    ...
    LazyLoadedSessionRecording.prototype._persistRemoteConfig = function (response) {
        var _this = this;
        var _a;
    ...
    LazyLoadedSessionRecording.prototype.onRemoteConfig = function (response) {
        var _this = this;
        var _a, _b, _c, _d, _e;
        ...
        (_e = this._removeEventTriggerCaptureHook) === null || _e === void 0 ? void 0 : _e.call(this);
    ...
    LazyLoadedSessionRecording.prototype._resetSampling = function () {
        var _a;
     ...
     */
    LazyLoadedSessionRecording.prototype._setupSampling = function () {
        var _this = this;

...
export function PersonaSelection({
  ...
  useEffect(() => {
    const generatePersonasForSegments = async () => {
      ...
      const primaryPersonaTypes: BuyerPersona[] = [
        {
          ...
          reads: ['Harvard Business Review', 'Industry reports', 'Leadership podcasts'],
        ...
        },
        {
          ...
          reads: ['Tech blogs', 'GitHub', 'Stack Overflow', 'Developer communities'],
        ...
        },
        {
          ...
          reads: ['Marketing publications', 'Case studies', 'Analytics dashboards'],
        ...
        },
        {
          ...
          reads: ['Operations journals', 'Process improvement guides', 'Lean methodologies'],
      ...
      const limitedPrimaryPersonas = quickStart ? primaryPersonaTypes.slice(0, 2) : primaryPersonaTypes;
      ...
      if (secondarySegment) {
        ...
        const limitedSecondaryPersonas = quickStart ? secondaryPersonaTypes.slice(0, 2) : secondaryPersonaTypes;
  ...
  const handlePersonaSelection = (personaId: string, type: 'primary' | 'secondary') => {
    if (type === 'primary') {
    ...
    const primary = allPersonas.find(p => p.id === (type === 'primary' ? personaId : primaryPersona));
    const secondary = type === 'secondary'
      ? (personaId === 'none' ? undefined : allPersonas.find(p => p.id === personaId))
      : (secondaryPersona ? allPersonas.find(p => p.id === secondaryPersona) : undefined);
    ...
    return (
      <div className="space-y-8">
        <div className="text-center py-12">
          ...
          <p className="text-lg font-medium mb-2">AI Generating Customer Personas</p>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-950/20 dark:to-blue-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-semibold text-green-900 dark:text-green-100 mb-2">AI-Generated Customer Personas</h3>
            <p className="text-sm text-green-700 dark:text-green-300">
              Based on your selected market segments, these personas represent your ideal customer profiles.
              Choose your primary ICP (Ideal Customer Profile) and optionally a secondary persona.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Select your primary and secondary Ideal Customer Profiles based on your chosen segments
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          <h3 className="text-lg font-medium">Primary Segment: {primarySegment.name}</h3>
                ...
                <div className="absolute top-3 right-3">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="primary" disabled={primaryPersona !== '' && !isPrimary}>
                        {primarySegment.name}
                      </SelectItem>
                      {secondarySegment && (
                        <SelectItem value="secondary" disabled={secondaryPersona !== '' && !isSecondary}>
                ...
                <div className="pr-28">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-xs font-medium text-blue-700 dark:text-blue-400">Key Traits</p>
                        <div className="flex flex-wrap gap-1 mt-1">
                          {persona.characteristics.slice(0, 3).map((trait, idx) => (
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-xs font-medium text-green-700 dark:text-green-400">Reads</p>
                        <p className="text-xs text-muted-foreground">{persona.reads.slice(0, 2).join(', ')}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-xs font-medium text-orange-700 dark:text-orange-400">Decision Trigger</p>
      ...
      {secondarySegment && (
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-medium">Secondary Segment: {secondarySegment.name}</h3>
      ...
      {primaryPersona && (
        <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <div className="space-y-2">
            <p className="font-medium text-blue-800 dark:text-blue-200">Selected ICPs:</p>
            <p className="text-sm text-blue-700 dark:text-blue-300">
              <strong>{primarySegment.name}:</strong> {allPersonas.find(p => p.id === primaryPersona)?.name}
              {secondaryPersona && secondarySegment && (
                <>
                  <br />
                  <strong>{secondarySegment.name}:</strong> {allPersonas.find(p => p.id === secondaryPersona)?.name}
                </>
              )}
            </p>
          </div>

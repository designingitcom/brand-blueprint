...
function ValuePropCard({ item, index }: ValuePropCardProps) {
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className="group bg-white border border-neutral-200 rounded-2xl p-8 hover:border-neutral-300 transition-all duration-300 hover:shadow-lg"
    >
      {/* Icon */}
        ...
        <div className="mx-auto max-w-7xl px-6 pt-32 pb-24 lg:px-8 lg:pt-40 lg:pb-32">
          <div className="mx-auto max-w-4xl text-center">
                ...
                { 
                  ...
                  icon: (
                    <svg className="w-8 h-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="8" cy="16" r="6" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                ...
                { 
                  ...
                  icon: (
                    <svg className="w-8 h-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <rect x="20" y="4" width="8" height="8" rx="1" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                      <rect x="4" y="20" width="8" height="8" rx="1" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                      <rect x="20" y="20" width="8" height="8" rx="1" stroke="currentColor" strokeWidth="1.5" fill="none"/>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="px-10 py-4 text-lg bg-neutral-900 hover:bg-neutral-800 text-white rounded-lg">
                Start Your 90-Day Pipeline
              </Button>
              <Button variant="outline" size="lg" className="px-10 py-4 text-lg border border-neutral-300 text-neutral-900 rounded-lg hover:bg-neutral-50">

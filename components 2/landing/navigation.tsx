      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Button variant="outline" size="sm" className="border-neutral-300 text-neutral-900 hover:bg-neutral-50 rounded-lg" asChild>
              <Link href="/login">Log In</Link>
            </Button>
            <Button size="sm" className="bg-neutral-900 hover:bg-neutral-800 text-white rounded-lg">
              Start Free Trial
            </Button>
          </div>

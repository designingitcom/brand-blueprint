...
export function ValidationSummary({
  ...
  const hiddenCount = (errors.length + warnings.length) - (visibleErrors.length + visibleWarnings.length);
...
export function useValidationFeedback(options: UseValidationFeedbackOptions = {}) {
